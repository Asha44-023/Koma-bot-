...
def scalp_plan(ex, free_bal, send_telegram, can_send):
    def _safe_send(msg):
        # HOUSE COMPLETELY BLOCKED
        if "HOUSE" in msg or "NEW DAILY" in msg:
            return
        try:
    ...
    try:
        ...
        if pos_side and entry>0:
            ...
            if now - last_flip > 180:
                if pos_side=='long' and pct >= MIN_LONG and rsi > 65:
                ...
                if pos_side=='short' and pct >= MIN_LONG and rsi < 35:
                ...
                if pos_side=='long' and pct >= FULL_HOUSE:
                    ex.create_market_order(SYMBOL,'sell',amt,params={"reduceOnly":True})
                ...
                if pos_side=='short' and pct >= FULL_HOUSE:
                    ex.create_market_order(SYMBOL,'buy',amt,params={"reduceOnly":True})
